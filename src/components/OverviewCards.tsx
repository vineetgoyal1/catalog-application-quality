      ...
      <div className="overview-progress-bar">
        ...
        {goodPct > 0 && (
          <div
            ...
            style={{ width: `${goodPct}%` }}
            title={`${good.toLocaleString()} applications (${goodPct.toFixed(1)}%)`}
            onClick={onClickGood}
            role="button"
            tabIndex={0}
          >
        ...
        {fairPct > 0 && (
          <div
            ...
            style={{ width: `${fairPct}%` }}
            title={`${fair.toLocaleString()} applications (${fairPct.toFixed(1)}%)`}
            onClick={onClickFair}
            role="button"
            tabIndex={0}
          >
        ...
        {needsWorkPct > 0 && (
          <div
            ...
            title={`${needsWork.toLocaleString()} applications (${needsWorkPct.toFixed(1)}%)`}
